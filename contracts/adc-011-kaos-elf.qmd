---
title: "Kaos Elf VHDL Violation Injector"
...
Create a systematic test harness that injects known VHDL hardware violations into working designs to validate the analyzer's detection capabilities. This "kaos elf" approach ensures comprehensive coverage of both catastrophic and subtle hardware errors.
...
```
contrib/lzx-kaos/
├── kaos-violations.json          # Master violation catalog
...
When implementing the kaos elf generator:
