...
- **Depends On**: ADC-011 (Kaos Elf), Parser Implementation
- **Iteration**: 3
- **Last Updated**: 2025-12-06

## Purpose

Implement static analysis violation detection based on priorities identified in KAOS_ELF_EVALUATION_REPORT.md. The kaos elf evaluation revealed 0% detection rate on expected violations (Levels 1-3). This contract addresses the three highest-priority detection gaps.
...
**Evaluation Results** (from KAOS_ELF_EVALUATION_REPORT.md):
...
- Priority 1 (Signal Usage): COMPLETE - detecting Level 1 violations
- Priority 2 (Control Flow): COMPLETE - detecting Level 2 latch inference
- Priority 3 (Arithmetic): COMPLETE - detecting Level 3 unbounded counters
- False Positive Rate: Acceptable (some legitimate warnings on clean corpus)
...
[ERROR] Signal Usage: Undriven signal
  File: contrib/lzx-kaos-levels/enhance-level1-undriven.vhd:41
...
[WARNING] Control Flow: Potential latch inference
  File: contrib/lzx-kaos-levels/enhance-level2-partial.vhd:41
...
[WARNING] Arithmetic Bounds: Unbounded counter
  File: contrib/lzx-kaos-levels/enhance-level3-bitgrowth.vhd:51
...
2. ✅ Kaos elf evaluation shows 3/3 detections (100%)
3. ✅ Clean corpus shows < 5% false positives
4. ✅ Updated KAOS_ELF_EVALUATION_REPORT.md generated
