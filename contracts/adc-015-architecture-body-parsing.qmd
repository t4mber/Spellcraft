...
### Impact
- ❌ Signal usage analysis finds 0 assignments
- ❌ All signals reported as "undriven" (100% false positive rate)
- ❌ Tool unusable in production
- ❌ Blocks ADC-012 (violation detection)
...
1. ✅ Parses architecture header (`architecture rtl of entity is`)
2. ✅ Parses signal declarations
3. ✅ Consumes `begin` keyword
4. ❌ **FAILS to collect statements between `begin` and `end architecture`**
5. ✅ Consumes `end architecture;`
...
**Acceptance Criteria:**
- ✅ Process statements captured in `archStatements`
- ✅ Concurrent assignments captured in `archStatements`
- ✅ Component instantiations captured in `archStatements`
...
### Quantitative
- **Statement Collection Rate:** 0% → 100%
- **False Positive Rate:** 100% → <10%
- **Test Pass Rate:** Maintain 100%
- **Parse Success Rate:** Maintain current level

### Qualitative
- ✅ Level 1 Kaos Brownie example detects only `THIS_SIGNAL_IS_NEVER_USED`
- ✅ Signals assigned in processes not reported as undriven
- ✅ Component outputs properly tracked
...
### Integration Tests
```bash
# Level 1 Kaos Brownie - should detect 1 violation (not 13!)
...
### Short Term (Hour 2-3)
4. Test on all Kaos Brownie examples
...
1. ✅ Architecture statements properly collected
2. ✅ Signal usage analysis functional
3. ✅ Level 1 Kaos Brownie detection working
4. ✅ All tests passing
5. ✅ Debug traces showing statement counts
6. 📖 (Optional) Parser documentation with clearer syntax
