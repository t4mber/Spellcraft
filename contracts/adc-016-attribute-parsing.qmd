...
Implement parsing of VHDL attribute access expressions (`identifier'attribute_name`) to unblock Level 1 Kaos Elf detection and achieve 90%+ parse success rate on LZX corpus.
...
- Level 1 Kaos Elf test fails completely
...
### Impact
- ❌ Level 1 Kaos Elf fails to parse
...
- **Level 1 Kaos Elf:** Parse failure → Correct detection
- **Test Pass Rate:** Maintain 100%

### Qualitative
- ✅ `test/fixtures/attribute.vhd` parses successfully
- ✅ Level 1 Kaos Elf detects only `THIS_SIGNAL_IS_NEVER_USED`
...
### Blocks
- Level 1 Kaos Elf detection - BLOCKED
...
4. ✅ Level 1 Kaos Elf parses and detects violations
